# Resumen de reunión · 16 junio 2026
> Canal: Temas y producción (canal colaborativo GCO + Pasiona + Raona)
...
# Notas de la reunión del 16 de junio
## Temas
Ajustes de los vídeos de configuración del entorno y los contenidos gráficos de la Semana 4.

**Vídeos — ajustes confirmados**

- Vídeo 1: se debe añadir el flujo completo de solicitud de licencia desde myaccess, incluyendo la búsqueda del paquete "GitHub Enterprise - Arquitectura"
- Vídeo 2: se debe reemplazar el usuario real de GCO por uno genérico y se debe ampliar la sección de VS Code con el flujo de autenticación completo
- Vídeo 3: sin cambios

**Semana 4 — contenido confirmado**

- Martes 23 jun: caso de uso real — entender código heredado con GitHub Copilot en COBOL
- Jueves 25 jun: caso de uso real — bug fixing con GitHub Copilot en .NET
