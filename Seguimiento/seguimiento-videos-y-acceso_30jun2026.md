...
- Faltan los **ajustes de los videos** (Yehimy está atrasada en eso).
- Colocó los contenidos de los casos de uso a partir de las **grabaciones de las sesiones** que le dio Nibaldo, pero no sabe si son los que él tiene en mente → pide que los **revise** para que la gráfica sea coherente con los videos que él va a grabar.
- Si Nibaldo tiene **videos nuevos**, los agradece para ir proponiendo los contenidos de la semana siguiente.

### Lo que Nibaldo entregó/respondió — 30 jun
- "Videos míos, los estoy haciendo, los tendré hoy."
- "Los casos de uso enviados."
- "Este último es de los MCP."
- "Tu VPN la estoy gestionando."
- "Te puse en copia."
- "Hablé también con Jonatan, él me explicó lo que necesitabas."
- "Necesito que me traslades con mayor claridad los puntos, porque entendí que era la VPN de GCO."
- Le pasó el **video de un caso de uso** (el que Yehimy estaba trabajando en brief) → pasa a producción esta semana.

---

## 2. Tareas por video

| Video | Tarea concreta | Responsable | Estado |
|-------|----------------|-------------|--------|
| **Video 01 — Configuración del entorno** | Publicar (edición finalizada el 12 jun) | Yehimy | Pendiente — bloqueado por URL del canal corporativo |
| **Video 01** | Regrabar el flujo completo de licencia en myaccess | Nibaldo | Pendiente |
| **Video 01** | Que el tema del **acceso** se vea reflejado en el video | Nibaldo | Pendiente |
| **Video 01** | Facilitar la **URL del canal corporativo** para el enlace | Nibaldo | Pendiente |
| **Video 02 — Primeros pasos** | Decidir enfoque entre los dos guiones (A/B) enviados | Nibaldo + equipo | Pendiente |
| **Video 02** | Ajuste: ocultar el dato del usuario en el login | Nibaldo | Por confirmar qué dato exacto ocultar |
| **Video 02** | Regrabar el flujo de autenticación de VS Code ("Sign in with GitHub") | Nibaldo | Pendiente |
| **Video Caso de uso 1 — COBOL heredado** | Descarga del video | Yehimy | ✅ Descargado el jueves |
...
## 4. Puntos pendientes de aclarar (Yehimy → Nibaldo)

> Nibaldo pidió explícitamente: "necesito que me traslades con mayor claridad los puntos, porque entendí que era la VPN de GCO".

- **VPN:** ✅ aclarado — es la **VPN de Raona** para que Yehimy (desde Colombia, donde el acceso está bloqueado) pueda ingresar al usuario de GCO y publicar en el Teams de GCO lo que está en el Teams local. No es la VPN de GCO. Nibaldo confirmó hoy (30 jun) que está en tránsito.
- **Video Caso de uso 1:** ✅ descargado el jueves — se produce esta semana.
- **Video MCP:** ✅ Nibaldo lo acaba de entregar — se produce esta semana.
- **Casos de uso "enviados":** ✅ aclarado — son los de la carpeta `semana-4_22-26jun/` (caso 1 COBOL y caso 2 bug fixing).
...
## 6. Referencia — check-in de la reunión (resumen IA, 25 jun)

> Puntos pendientes que la IA recogió en el punto medio de la reunión (contexto, no tareas nuevas — ya cubiertos arriba):
> - Cerrar las correcciones de los videos semanales y del contenido gráfico, incluidos permisos/bloqueos pendientes.
> - Confirmar los casos de uso reales a incluir en las comunicaciones de la próxima semana y atender el feedback.
