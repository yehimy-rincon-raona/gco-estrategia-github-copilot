# Solicitudes a Guillermo · 16 junio 2026

> Estado: pendiente de enviar
> Origen: reunión 16 jun + bloqueante activo de acceso al Teams de GCO
...
## Contexto interno (no va en el mensaje)

**Por qué es Guillermo y no Nibaldo:**
Nibaldo es el experto técnico de GitHub Copilot. El acceso al Teams de GCO es un asunto de relación con el cliente — corresponde a Guillermo como lead de cuenta coordinarlo con GCO.

**Qué se está pidiendo crear o acceder:**
El equipo de Teams en el tenant de Occident con estos 6 canales:

| Canal | Propósito |
|-------|-----------|
| General | Entrada e índice de la comunidad |
| Anuncios y Tips Ágiles | Tips, casos reales, novedades |
| Primeros Pasos con GitHub Copilot | Ruta secuencial de activación |
| Casos de Uso Reales | Casos prácticos con COBOL, .NET, DB2, PL/SQL |
| Foro de Ayuda / AMA | Espacio abierto de preguntas |
| Reservas 1:1 con Expertos | Enlace a Microsoft Bookings |
