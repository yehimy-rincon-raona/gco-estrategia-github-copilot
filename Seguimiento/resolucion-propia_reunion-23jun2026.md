...
> Fuente de los temas: reunión 16 jun + feedback Jonathan.
...
3. **Facturación** (ítem 7): investigar en la web el modelo de facturación público actual de GitHub Copilot y documentarlo para la card de tokens.
