...
| `F2` | `infografía` | Vertical 1080×1350 px | Jerarquía/pirámide, procedimiento largo, o fórmula desglosada en componentes | B (jerarquía/pirámide) · C (paso a paso largo) · D (fórmula/componentes) | `infografia_jerarquia-piramide.jpg` · `infografia_paso-a-paso-largo.jpg` · `infografia_formula-componentes.jpg` (pendiente) |
...
- **Imagen de referencia:** `infografia_formula-componentes.jpg` `[imagen pendiente de generar — esta variante nace con la pub 8; usar la primera pieza aprobada como referencia futura]`.
