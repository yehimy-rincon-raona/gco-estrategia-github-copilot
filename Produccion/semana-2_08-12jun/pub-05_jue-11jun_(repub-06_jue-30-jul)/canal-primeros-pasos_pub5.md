...
> Texto verificado contra la captura (`Produccion/imagenes_teams/02_primeros-pasos/06-pub-03_copias-y-pegas-codigo-en-el-chat.png`) — coincide con lo publicado.
...
> El post principal va con `1-S2-Infografia_pub5` (infografía de jerarquía). Cada respuesta a continuación acompaña una pieza y le da contexto al equipo antes o después de compartirla.

---

### Respuesta 1 — acompaña `1-S2-Infografia_pub5` (infografía)
...
### Respuesta 2 — acompaña `2-S2-card_pub5` (card-minimalista)
