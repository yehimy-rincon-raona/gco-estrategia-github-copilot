...
> Estado: ✅ Publicado — captura en `Produccion/imagenes_teams/02_primeros-pasos/`
> Fuente: sesiones Nibaldo · prop_memoria-copilot.md
> ⚠️ **Orden de publicación (comentario de Jonatan en Teams, 16 jun):** en el despliegue del Teams oficial de GCO, este post va **después** del post "¿GitHub Copilot no aparece en tu Visual Studio?" (tarjetas de licencia, Pub 2) — ese apartado queda como segunda publicación del canal.
...
> Texto idéntico a la publicación verificada en la captura (`04-pub-02_en-ocasiones-se-pone-tonto-a-mitad-de-la-tarea.png`). El titular del cuerpo se actualizó contra la captura: antes este documento decía "GitHub Copilot se pone tonto a mitad de la tarea".

**Asunto:** `GitHub Copilot no tiene memoria permanente. Tiene un cajón.`

---

🧠 **¡En ocasiones se pone tonto a mitad de la tarea!**
...
## Piezas publicadas (transcripción desde la captura de Teams)

> El post publicado lleva **3 tarjetas adjuntas** (no la infografía única del brief original de abajo). Texto legible en la captura:

| Tarjeta | Texto legible |
|---------|---------------|
| 1 — Cajón (ilustración) | "No tiene una memoria infinita" |
| 2 — El problema | "La saturación da respuestas erróneas." · "Esto provoca que el modelo mezcle conceptos, invente soluciones o se vuelva lento." · "'El síntoma del mareo'" · "Ocurre cuando la herramienta pierde el hilo debido al exceso de información acumulada." |
| 3 — La solución (fondo rojo) | "Gestión inteligente del contexto" · 1 "Limpieza y nuevos hilos" · 2 "Enfoque 'Uno por uno'" · "¡Menos es más!" · "La calidad de la respuesta depende directamente de la precisión de lo que dejas en el cajón." |

> Los textos secundarios de las tarjetas 1 y 3 no son completamente legibles en la captura — `[No hay información — confirmar con Yehimy si se necesita la transcripción completa]`.

---

## Infografía / pieza gráfica (brief original — no fue la pieza publicada)
