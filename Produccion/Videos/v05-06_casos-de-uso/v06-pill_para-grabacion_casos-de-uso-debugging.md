...
## Debugging del frontend al COBOL: el radio button que se reseteaba y el combo que se recalculaba
...
Usa los 2 casos de **debugging** que quedaron fuera del Video 05: el radio button que se resetea y el combo que se recalcula al grabar. Duración objetivo: **1:45 – 2:15 min**.
...
Texto en pantalla: **"2 bugs reales · del frontend al COBOL"**.

---

### Sección 2 | Caso 01 · Bug 1: el radio button que se reseteaba

**Voz en off:**
> Primer bug: un formulario con un radio button que marca si la gestión es de defensa o de reclamación. Al dar de alta y recargar la página, ese radio button se cambiaba solo de una opción a la otra, arrastrando otros datos de la pantalla.
>
> GitHub Copáilot revisó el JavaScript del formulario y encontró la causa: al pulsar el alta se calculaba una variable que no se guardaba ni se reinyectaba al volver del backend. Su valor se perdía en cada recarga.
>
...
Texto en pantalla: **"Radio button que se resetea → variable de estado que no se guardaba"**.

---

### Sección 3 | Caso 02  · Bug 2: el combo que se recalculaba al grabar

**Voz en off:**
> Segundo bug, en una pantalla antigua con muchas listas desplegables — los combos — que dependen unas de otras: eliges un valor en una y se recalculan las demás.
>
...
| S2 | Sesión del radio button | `30` | Radio button que se resetea | — |
