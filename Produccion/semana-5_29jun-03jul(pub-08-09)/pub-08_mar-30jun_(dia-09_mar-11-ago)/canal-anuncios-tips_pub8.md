...
- **Respuesta 1:** el mismo prompt mal y bien escrito (antes/después) con el caso real de GCO → adjunta la **imagen de apoyo del ejemplo (pieza 2)**.
- **Respuesta 2 (opcional):** la plantilla en blanco para copiar → solo texto, sin gráfica.
...
| Reglas de código GCO (refuerzo para parte 2) | Tarjeta `5-S2` · `copilot-instructions.md` del proyecto |

---

## Posts de hilo

> El post principal va con la infografía/tarjeta de la fórmula. Respuesta 1 aterriza el antes/después. Respuesta 2 (opcional) entrega la plantilla en blanco.

---

### Respuesta 1 — el mismo prompt, dos resultados
...
### Respuesta 2 — (opcional) plantilla para copiar
...
**Acompaña:** el Respuesta 1 del hilo
...
> El diseño de esta pieza ya está aprobado; esta tabla registra su contenido para validación de información. La plantilla en blanco (Respuesta 2) no va en esta pieza — es solo texto.
