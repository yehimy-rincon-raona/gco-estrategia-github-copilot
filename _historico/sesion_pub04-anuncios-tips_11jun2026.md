# Resumen de sesión — Pub 04 · Canal Anuncios y Tips Ágiles · 11 junio 2026
> Continúa desde: `sesion_cards-brief-y-regla-transversal_10jun2026.md`
...
## Archivos de salida de pub-04

| # | Nombre de archivo | Tipo | Tema |
|---|-------------------|------|------|
| 1 | `1-S2-card_pub4` | card-comparativa · 1920×1080 px | Optimización de Tokens y Modelos |
| 2 | `2-S2-card_pub4` | card-minimalista · 1080×1350 px | Diseñe la solución con un modelo Premium. |
| 3 | `3-S2-card_pub4` | card-minimalista · 1080×1350 px | Carga progresiva de Skills |
| 4 | `4-S2-card_pub4` | card-minimalista · 1080×1350 px | Higiene de la memoria a corto plazo |
| 5 | `5-S2-card_pub4` | card-comparativa · 1920×1080 px | Memoria vs. Instrucciones |
...
- **Restricciones GCO en la tarjeta 5** vienen de las sesiones de Nibaldo (confirmadas en `propuestas-nibaldo/resumen_nibaldo-copilot-instructions.md`):
  ...
  - Todos: sin credenciales/tokens/passwords hardcodeados
- **`copilot-instructions.md` aplica igual en VS y VS Code** — confirmado por Nibaldo en sesiones (fuente: mismo archivo).
...
| Aprobación pub-03 y pub-04 | Nibaldo / Guillermo | Pendiente (lunes 8 jun — puede haberse movido) |
| Manual de marca Occident | Guillermo | Pendiente |
| Acceso Teams GCO | Catalana Occidente | Bloqueante activo |
| Pub 05 (jueves 11 jun) | Yehimy | En borrador — no cerrada esta sesión |
